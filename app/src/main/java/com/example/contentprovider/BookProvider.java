...
import com.example.contentprovider.db.DbOpenHelper;
...
public class BookProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.contentprovider.BookProvider";
    ...
    private void initProvider(){
        mDb = DbOpenHelper.getHelper(mContext).getWritableDatabase();
        ...
        mDb.execSQL("insert into user values(2,'zhou',0);");
    }
    ...
    public String getType(@NonNull Uri uri) {
        Log.e(TAG, "getType: thread = " + Thread.currentThread().getName());
        return null;
    }
